...
export const occupationalSkills: Record<string, IOccupationalSkill> = {
  ...
  increasedAlchemicalProduction: {
    name: 'Increased Alchemical Production',
    id: 'increasedAlchemicalProduction',
    cost: 40,
    description: '',
    tier: 4,
  ...
  immuneToLethalAlchemicalVenoms: {
    name: 'Immune to Lethal Alchemical Venoms',
    id: 'immuneToLethalAlchemicalVenoms',
    cost: 40,
    description: '',
    tier: 4,
  },
  armoursmithApprentice: {
    ...
    id: 'armoursmithApprentice',
    cost: 10,
    description: '',
    tier: 1,
  },
  repairEnchantedItems: {
    name: 'Repair Enchanted Items',
    id: 'repairEnchantedItems',
    cost: 20,
    description: '',
    tier: 2,
  ...
  weaponsmithApprentice: {
    ...
    id: 'weaponsmithApprentice',
    cost: 10,
    description: '',
    tier: 1,
  },
  repairDestroyedItems: {
    name: 'Repair Destroyed Items',
    id: 'repairDestroyedItems',
    cost: 20,
    description: '',
    tier: 2,
  ...
  immuneToRepelAndStrikedown: {
    name: 'Immune to Repel and Strikedown',
    id: 'immuneToRepelAndStrikedown',
    cost: 30,
    description: '',
    tier: 3,
  ...
  additionalReforging: {
    name: 'Additional Reforging',
    id: 'additionalReforging',
    cost: 10,
    description: '',
    tier: 1,
  },
  spellTempering: {
    name: 'Spell Tempering',
    id: 'spellTempering',
    cost: 30,
    description: '',
    tier: 3,
