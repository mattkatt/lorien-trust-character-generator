...
export const CharacterSkills: FC = () => {
    ...
    const characterSkillLists: Array<CharacterSkillList> = ['weaponSkills', 'armourSkills', 'knowledgeSkills', 'powerSkills']

    return (
        <>
            <h2>Character Skills</h2>
            <Paragraph>Skill Point Spend: {spentCharacterSkillPoints} / {characterSkillPoints}</Paragraph>
